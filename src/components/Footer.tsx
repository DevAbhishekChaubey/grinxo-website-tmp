    ...
    <footer>
      <div className="wrap">
        <div className="foot-grid">
          <div>
            <div className="logo">
              <Image src="/assets/grinxo-mark.png" alt="GrinXO" width={100} height={30} />
            </div>
            <span className="soon-pill"><span className="dot"></span> Full booking platform launching soon</span>
          ...
          <div>
            <h4>Explore</h4>
            <ul>
              <li><a href="#bring">What we do</a></li>
              <li><a href="#how">How it works</a></li>
              <li><a href="#experiences">Experiences</a></li>
              <li><a href="#why">Why GrinXO</a></li>
            </ul>
          </div>
          <div className="foot-contact">
            <h4>Get in touch</h4>
            <ul>
              <li><a href={waLink} target="_blank" rel="noopener">
              ...
              <li><a href="mailto:hello@grinxo.com">
        ...
        <div className="foot-credits">
          Images by <a href="https://www.freepik.com" target="_blank" rel="noopener">freepik</a>,
          <a href="https://www.freepik.com" target="_blank" rel="noopener">frimufilms</a> and
          <a href="https://www.freepik.com" target="_blank" rel="noopener">freepic.diller</a> on Freepik.
        </div>
      </div>
    </footer>
  );
