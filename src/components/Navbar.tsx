    ...
    return (
        <header>
            <div className="wrap nav">
                <a href="#top" className="logo" aria-label="GrinXO Logo" style={{ display: "flex", alignItems: "center" }}>
                    <Image src="/assets/logo.png" alt="GrinXO Logo" width={220} height={53} style={{ objectFit: 'contain' }} priority />
                </a>
                <nav className="nav-links">
                    <a href="#bring">What we do</a>
                    <a href="#how">How it works</a>
                    <a href="#experiences">Experiences</a>
                    <a href="#why">Why GrinXO</a>
                </nav>
                ...
                <button className="menu-btn" id="menuBtn" aria-label="Open menu" onClick={() => { window.location.href = "#how"; }}>
